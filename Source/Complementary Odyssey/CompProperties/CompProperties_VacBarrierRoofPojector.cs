...
{
    public class CompProperties_VacBarrierRoofPojector : CompProperties_Power
    {
        ...
        public CompProperties_VacBarrierRoofPojector()
        {
            compClass = typeof(CompVacBarrierRoofPojector);
        }
